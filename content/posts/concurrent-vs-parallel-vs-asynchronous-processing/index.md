...
<div class="note">
    <strong>Note:</strong> In practice parallel and concurrent computing goes toe to toe. Modern PCs have multiple CPU cores meaning they can perform multiple tasks at the time, and at the same time, your PC always has much more tasks than cores in progress that all may need some attention from the processor.
</div>
